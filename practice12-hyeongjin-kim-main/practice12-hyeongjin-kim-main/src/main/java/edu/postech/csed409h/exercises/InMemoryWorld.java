...
public class InMemoryWorld implements WorldDAO {
    ...
    private static InMemoryWorld instance;

    public static InMemoryWorld getInstance() {
        synchronized (InMemoryWorld.class) {
            if (instance == null)
                instance = new InMemoryWorld();
        }
        return instance;
    }

    private InMemoryWorld() {
