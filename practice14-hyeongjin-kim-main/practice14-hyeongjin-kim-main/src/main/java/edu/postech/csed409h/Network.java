...
import edu.postech.csed409h.internals.*;
...
public class Network {
    ...
    public boolean requestWorkstationPrintsDocument(String workstation,
        ...
        tryreportrequest(workstation, document, printer, report);
    ...
    private void tryreportrequest(String workstation,
                           String document, String printer, Writer report){
        try {
            report.write("'");
    ...
    private void tryreportnode(Writer report, Node currentNode){
        try {
            report.write("\tNode '");
            report.write(currentNode.name);
            report.write("' passes packet on.\n");
